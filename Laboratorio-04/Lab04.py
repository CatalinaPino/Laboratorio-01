...
## Cálculo Sk y gráficos de archivo UNI_CORR_500_01.txt
...
ax.set_title('Histograma velocidades', loc='center', fontdict = {'fontsize':14,'fontweight':'bold','color':'black'})
#plt.show() 
st.pyplot(fig)
...
ax.set_title('Gráfico de Dispersión: sk vs. Velocidad', loc='center', fontdict = {'fontsize':14,'fontweight':'bold','color':'black'})
ax.grid(True)
#plt.show()
st.pyplot(figu)
